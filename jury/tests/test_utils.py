...
from jury import is_reduce_fn
from jury.utils import remove_punctuations, bulk_remove_keys


def test_remove_punctuations():
	test_text = (
		"!*This, a (test); text. Testing: 123 alpha123. "
		"Multiple    spaces     uneven sizes,and-also-this."
	)
	resulting_text = (
		"This a test text Testing 123 alpha123 Multiple spaces "
		"uneven sizes and also this"
	)
